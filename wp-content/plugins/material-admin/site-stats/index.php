...
function mtrl_pagestats_add_dashboard() {
  wp_add_dashboard_widget( 'pagestats_wp_dashboard', 'Pages Count & Type', 'mtrl_pagestats_dashboard_output' );
}
...
function mtrl_poststats_add_dashboard() {
  wp_add_dashboard_widget( 'poststats_wp_dashboard', 'Posts Statistics', 'mtrl_poststats_dashboard_output' );
}
...
function mtrl_commentstats_add_dashboard() {
  wp_add_dashboard_widget( 'commentstats_wp_dashboard', 'User Comments', 'mtrl_commentstats_dashboard_output' );
}
...
function mtrl_catstats_add_dashboard() {
  wp_add_dashboard_widget( 'catstats_wp_dashboard', 'Category Statistics', 'mtrl_catstats_dashboard_output' );
}
...
function mtrl_userstats_add_dashboard() {
  wp_add_dashboard_widget( 'userstats_wp_dashboard', 'User Statistics', 'mtrl_userstats_dashboard_output' );
}
