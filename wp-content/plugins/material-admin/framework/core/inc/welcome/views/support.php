<div class="wrap about-wrap" xmlns="http://www.w3.org/1999/html">
    <h1><?php esc_html_e( 'Redux Framework - Support', 'mtrl_framework' ); ?></h1>
    ...
    <div class="redux-badge">
        ...
        <span><?php printf( __( 'Version %s', 'mtrl_framework' ), esc_html(ReduxFramework::$_version) ); ?></span>
    </div>
        ...
        <form id="supportform">
                ...
                <table id="user_type">
                    <tr>
                        ...
                        <td id="is_developer">
                            ...
                            <small>
                                <?php esc_html_e( 'I am a developer, building a product using Redux.', 'mtrl_framework' ); ?>
                            </small>
                        </td>
                    </tr>
                </table>
            ...
            <fieldset id="final_support">
                ...
                <div class="is_developer">
                    <p>
                        <?php esc_html_e( 'Please proceed to the Redux Framework issue tracker and supply us with your support URL below. Please also provide any information that will help us to reproduce your issue.', 'mtrl_framework' ); ?>
                    </p>
...
?>
                ...
                <p>
                    <em>
                        <?php echo sprintf( wp_kses( __( 'Should the developer not be responsive, read the <a href="%s" target="_blank">following article</a> before asking for support from us directly.', 'mtrl_framework' ), array( 'a' => array( 'href' => array() ) ) ), esc_url( 'http://docs.reduxframework.com/core/support-defined/' ) );?>
                    </em>
                </p>
                <input type="button" 
                       name="previous" 
